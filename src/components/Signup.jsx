...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center  text-black bg-gray-100 px-4 dark:bg-gray-900 dark:text-black">
      <div className="bg-white rounded-xl shadow-md overflow-hidden flex flex-col md:flex-row max-w-4xl w-full">
        ...
        <div className="w-full md:w-1/2 p-8">
          ...
          <p className="mb-6 text-gray-600 dark:text-gray-300 text-lg">Let's create your Account</p>
